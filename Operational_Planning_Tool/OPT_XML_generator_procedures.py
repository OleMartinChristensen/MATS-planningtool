...
def Standard_binning_procedure(root, relativeTime, nadir, ExpIntUV = '3001', ExpTimeUV = '3000', ExpIntIR = '5001', ExpTimeIR = '5000', comment = ''):
    ...
    relativeTime = TC_pafCCDMain(root, relativeTime, CCDselect = '3', CCDMode = '1', ExpInterval = ExpIntUV, ExpTime = ExpTimeUV, comment = comment, 
                  NumRowsSkip = '100', NumRowsBin= '2', NumRows = '400', NumColumnsBin = '40', NumColumns = '2000')
    
    
    relativeTime = TC_pafCCDMain(root, relativeTime, CCDselect = '12', CCDMode = '1', ExpInterval = ExpIntIR, ExpTime = ExpTimeIR, comment = comment, 
                  NumRowsSkip = '100', NumRowsBin= '3', NumRows = '400', NumColumnsBin = '81', NumColumns = '2000')
    
    
    relativeTime = TC_pafCCDMain(root, relativeTime, CCDselect = '48', CCDMode = '1', ExpInterval = ExpIntIR, ExpTime = ExpTimeIR, comment = comment, 
                  NumRowsSkip = '100', NumRowsBin= '7', NumRows = '400', NumColumnsBin = '409', NumColumns = '2000')
    
    
    relativeTime = TC_pafCCDMain(root, relativeTime, CCDselect = '64', CCDMode = nadir, ExpInterval = '1400', ExpTime = '1000', comment = comment, 
...
def Full_CCD_stopNadir_procedure(root, relativeTime, comment = ''):
    ...
    relativeTime = TC_pafCCDMain(root, relativeTime, CCDselect = '64', CCDMode = '0', ExpInterval = '1400', ExpTime = '1000', comment = comment, 
                  NumRowsSkip = '0', NumRowsBin= '110', NumRows = '500', NumColumnsBin = '196', NumColumns = '1980', JPEGquality = '100')
