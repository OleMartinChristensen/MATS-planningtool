# -*- coding: utf-8 -*-
"""
Compares parameters given in the Science Mode Timeline to default parameters given in OPT_Config_File or stated here.
Fills in any parameters missing in the Science Mode Timeline. Then calls for macros, which will generate commands in the XML-file.
