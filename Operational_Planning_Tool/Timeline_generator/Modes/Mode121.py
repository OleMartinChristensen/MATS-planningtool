...
def date_calculator():
    ...
    initial_time = ephem.Date( timeline_start + ephem.second*Mode121_settings()['freeze_start'] )
    ...
    LP_altitude = Mode121_settings()['LP_pointing_altitude']/1000  #Altitude at which MATS center of FOV is looking [km]
    pointing_altitude = Mode121_settings()['pointing_altitude']/1000 
