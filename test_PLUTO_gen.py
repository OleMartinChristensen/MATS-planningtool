...
def test_write_header():
    pluto.PLUTOGenerator.write_header("test_header.plp")
    return


def test_write_footer():
    pluto.PLUTOGenerator.write_header("test_footer.plp")
    pluto.PLUTOGenerator.write_footer("test_footer.plp")
    return


def test_write_all():
    pluto.PLUTOGenerator.PLUTO_generator(
        "test_data/XML_TIMELINE__MinimalScience_.xml", "minimal_science.plp"
    )
    return
...
def test_write_mimnimal_script():
    pluto.PLUTOGenerator.PLUTO_generator(
        "test_data/XML_TIMELINE__MinimalPluto_.xml", "minimal_pluto.plp"
    )
    return
