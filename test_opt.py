...
"Optionally Choose your Configuration File ('OPT_Config_File') but use the TLE and start date values given directly in the Configuration File"
...
Data_MATS, Data_LP, Time, Time_OHB  = OPT.Timeline_Plotter('Output\Science_Mode_Timeline__OPT_Config_File.json', Timestep=20)
...
#Data_MATS, Data_LP, Time, Time_OHB  = OPT.Timeline_Plotter('OPT\Example_Science_Mode_Timeline__OPT_Config_File.json', STK_CSV_PATH='ExampleCSVfile.csv', 
#        OHB_H5_Path='OPT\ExampleH5file_LEVEL_1A_PLATF_20200120-094217_20200120-102136.hdf5', Timestep=20)

"Open plots previously created with Timeline_Plotter"
#OPT.Plot_Timeline_Plotter_Plots('Output/Science_Mode_Timeline__OPT_Config_File/Timeline_Plotter_PlotsAndData')

"Return the active science mode and its settings at a specfic date from a Science Mode Timeline"
#Mode, Parameters = OPT.Timeline_analyzer('Output/Science_Mode_Timeline__OPT_Config_File.json', '2020-06-20 19:30:00')
